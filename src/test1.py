...
X1 = input_X[input_y==0]
X2 = input_X[input_y==1]
X = X1.append(X2)
y = []
X = X.values
...
#plt.title("The cost of training a SVM between label 0 and label 1")
plot_cost_history(optimizer.cost_history, title="The cost of training a SVM between label 0 and label 1")
plt.show()